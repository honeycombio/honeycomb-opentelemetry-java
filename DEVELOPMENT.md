...
```sh
$ cd ~/.m2/repository/io/honeycomb/honeycomb-opentelemetry-sdk/0.2.1
$ ls -1
honeycomb-opentelemetry-sdk-0.2.1.jar
honeycomb-opentelemetry-sdk-0.2.1.module
honeycomb-opentelemetry-sdk-0.2.1.pom
