...
public final class HoneycombSdk implements OpenTelemetry {
    ...
    public static class Builder {
        ...
        public HoneycombSdk build() {
            ...
            SpanProcessor compositeProcessor = SpanProcessor.composite(
                new MetadataSpanProcessor(), BatchSpanProcessor.builder(exporter).build());

            SdkTracerProviderBuilder tracerProviderBuilder = SdkTracerProvider.builder()
                .setSampler(sampler)
                .addSpanProcessor(compositeProcessor);
