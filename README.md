...
Download the [latest version](https://github.com/honeycombio/honeycomb-opentelemetry-java/releases/download/v0.2.1/honeycomb-opentelemetry-javaagent-0.2.1-all.jar).

The agent is run as a `-javaagent` alongside your application.

```sh
java -javaagent:honeycomb-opentelemetry-javaagent-0.2.1-all.jar -jar myapp.jar
```
...
-javaagent:honeycomb-opentelemetry-javaagent-0.2.1-all.jar -jar myapp.jar
```
